...
class Objective(object):
    ...
    def compute_cost(self, state: torch.Tensor, t: int):
        ...
        if t == 0:
            ...
            self.obstacles.create_gaussians(self.obstacles.state_coordinates[:, 0],
                                self.obstacles.state_coordinates[:, 1],
                                self.obstacles.state_cov)
        ...
        return goal_dist * 1.0 + total_obstacle_cost * 10.0
